...
plot file.".dat" u ($1/100):($48) axis x1y1 w l lw 2 lc rgb"blue" title "ene_e"
replot file.".dat" u ($1/100):($58) axis x1y1 w l lw 2 lc rgb"purple" title "ene_v" 
#plot file.".dat" u ($1/100):($18) axis x1y1 w l lw 2 lc rgb"orange" title "joule" 
#replot file.".dat" u ($1/100):($24*$3*1.60E-19) axis x1y1 w l lw 2 lc rgb"red" title "vib rate" #J/m3/s
