...
replot file.".dat" u ($1/100):($14) axis x1y2 w l dt(10,5) lw 2 lc rgb"blue" title "Te"
replot file.".dat" u ($1/100):($15) axis x1y2 w l dt(10,5) lw 2 lc rgb"purple" title "Tv"
replot file.".dat" u ($1/100):($16) axis x1y2 w l dt(10,5) lw 2 lc rgb"red" title "Tg"
