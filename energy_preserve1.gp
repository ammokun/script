...
set lmargin 15
set rmargin 20
plot file.".dat" u ($1/100):(($49+$50)) axis x1y1 w l lw 2 lc rgb"purple" title "W electron collision" #
...
plot file.".dat" u ($1/100):($8*$8/$28*1.7587E11) axis x1y1 w l lw 2 lc rgb"blue" title "W  by field"
