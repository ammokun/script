...
set nokey
plot "~/Dropbox/labratory/ukaren2021/tetgtv.dat" u 1:($4/$2) axis x1y1 w lp lw 3 pt 5 ps 2  dt (10,5) lc rgb"blue" title "Sim. T_g / T_e" 
replot "tabata_tvtr.dat" u (sqrt($1*377*1E9)/1E6):($2/$3) axis x1y1 w lp lw 3 pt 5 ps 2 dt (10,5)  lc rgb"orange" title "Tabata's exp. T_r / T_v" 
