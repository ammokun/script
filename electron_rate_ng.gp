...
#replot file.".dat" u ($1/100):($12*1E-6) axis x1y2 w l dt(10,5) lw 2 lc rgb"red" title "ng"
replot file.".dat" u ($1/100):($3*1E-6) axis x1y2 w l dt(10,5) lw 2 lc rgb"black" title "ne"
