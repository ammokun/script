...
#plot file.".dat" u ($1/100):(($49+$50)*$3) axis x1y1 w l lw 2 lc rgb"purple" title "W electron collision" #
#plot file.".dat" u ($1/100):($44*0.9) axis x1y1 w l lw 2 lc rgb"red" title "W  photo electron" 
plot file.".dat" u ($1/100):($8*$8*$3/$28*1.7588*1E11) axis x1y1 w l lw 2 lc rgb"blue" title "W  by field" 
...
replot file.".dat" u ($1/100):($8*$8*$3/$28*1.7588*1E11-($49+$50)*$3) axis x1y1 w l lw 2 lc rgb"red" title "Source term" 
